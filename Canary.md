...
and then do our regression analysis.
    ...
    Time:                        11:37:57   Log-Likelihood:                 64148.
...
We have the plots for the time series and histograms for each cluster. I ran the
code a few times and the clusters found were very robust. The cluster for Region
0, the closest one to the disaster, has data corresponding to just a couple of
days towards the end of March 2012, which may be too short a period of time to
find a decreasing trend.
